...
from math import *
from Qcover_quark.optimizers import Optimizer
from Qcover_quark.exceptions import ArrayShapeError
...
class Fourier(Optimizer):
    ...
    def __init__(self,
        ...
        Args:
            ...
            q: the maximum frequency component allowed in the amplitude parameters <?u, ?v>
